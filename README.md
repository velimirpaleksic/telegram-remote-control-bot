...
- Commands:
  - STATUS:
    - [ ] /status: Provides the current status of the system (e.g., uptime, current user, etc.)

    - [ ] /diskusage: Displays information about disk space usage on the machine

    - [ ] /getinfo: Provides detailed system information such as OS version, CPU usage, and memory usage
  ...
  - FILE EXPLORER:
    ...
    - [ ] /getlogs: Retrieves system logs or application logs for troubleshooting
